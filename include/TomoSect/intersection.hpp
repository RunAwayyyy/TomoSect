...
using IntersectionResult =
    std::tuple<point3<Value>, typename point3<Value>::Mask>;

template <typename Value>
IntersectionResult<Value> intersection(const ray<Value> &ray,
                                       const aabb<Value> &aabb,
