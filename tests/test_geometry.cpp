...
//        SUBCASE("At origin with scale") {
//            rectangle rect = rectangle(point2<float>(10), point2<float>(0), vec2<float>{3, 2});
//
//            auto min = rect.min();
//            CHECK(min.x() == -1.5);
//            CHECK(min.y() == -1);
...
//        }
//        SUBCASE("Shifted") {
//            rectangle rect = rectangle(point2<float>(10),point2<float>(-1, 3), vec2<float>{1, 1});
//
//            auto min = rect.min();
//            CHECK(min.x() == -1.5);
//            CHECK(min.y() == 2.5);
...
//            rectangle rect = rectangle(point2<float>(10),point2<float>(0), vec2<float>{1, 1});
//
//            for(int x=0; x<10; x++) {
//                for(int y=0; y<10; y++) {
