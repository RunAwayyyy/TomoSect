...
TEST_CASE("Testing conversion from cartesian to cylindrical") {
    SUBCASE("Test 1:") {
        point3<float> p {1, 1, 1};

        auto cylindrical = toCylindrical(p);
        auto cartesian = toCartesian(cylindrical);

        CHECK(p.x() == doctest::Approx(cartesian.x()));
        CHECK(p.y() == doctest::Approx(cartesian.y()));
        CHECK(p.z() == doctest::Approx(cartesian.z()));
    }
}
...
TEST_CASE("Test Rectangle")
{
    SUBCASE("Construction")
    {
        ...
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0, 0, 0), Angle(0), Angle(0), Angle(-90));
        ...
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0, 0, 0), Angle(90), Angle(0), Angle(0));
        ...
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0.5, 0.5, 0), Angle(0), Angle(0), Angle(0));
        ...
        SUBCASE("Shifted by 0.5 in x and y direction, rotate 90 degree around z-axis")
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0.5, 0.5, 0), Angle(0), Angle(0), Angle(90));
        ...
        SUBCASE("Shifted by 0.5 in x and y direction, rotate 90 degree around x-axis")
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0.5, 0.5, 0), Angle(90), Angle(0), Angle(0));
        ...
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0, 0, 0), 2, Angle(0), Angle(0), Angle(0));
        ...
        {
            using Angle = degree<float>;
            auto rect = rectangle(point2<float>(10), vec3<float>(0, 0, 0), 2, Angle(-90), Angle(0), Angle(0));
...
TEST_CASE("Test Curved Rectangle")
{
    SUBCASE("Construction")
    {
        SUBCASE("At origin")
        {
            ...
            CHECK(center_45_degree.x() == doctest::Approx(-std::cos(degree<float>(45).to_radian())));
            CHECK(center_45_degree.y() == doctest::Approx(0));
            CHECK(center_45_degree.z() == doctest::Approx(-std::cos(degree<float>(45).to_radian())));

            auto center_135_degree = rect.coordFromLocal(point2<float>{ 0.75, 0.5 });
            CHECK(center_135_degree.x() == doctest::Approx(std::cos(degree<float>(45).to_radian())));
            CHECK(center_135_degree.y() == doctest::Approx(0));
            CHECK(center_135_degree.z() == doctest::Approx(-std::cos(degree<float>(45).to_radian())));
        ...
        {
            using Angle = degree<float>;
            auto rect = curved_rectangle(point2<float>(1), point3<float>(0, 0, -2), 6);
        ...
        {
            using Angle = degree<float>;
            auto rect = curved_rectangle(point2<float>(10), point3<float>(1, 1, 0), point3<float>(1, 1, -1));
