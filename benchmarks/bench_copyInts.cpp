...
public:
    ...
    CopyCountingInt(const CopyCountingInt& other) : val(other.val) { CopyCountingInt::copiesCounted++; }
...
public:
    ...
    virtual void setUp(const celero::TestFixture::ExperimentValue& experimentValue) override { this->arraySize = experimentValue.Value; }
