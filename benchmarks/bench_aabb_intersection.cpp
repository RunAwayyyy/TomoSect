...
BENCHMARK_F(HitAABB, PackOf16, IntersectionFixture<pack16<float>>, SAMPLES, ITERATIONS) {
    for (auto r : rays_) {
        auto hit = intersection(r, aabb_, ray_aabb_intersection{});
        celero::DoNotOptimizeAway(hit);
    }
...
BENCHMARK_F(HitAABB, PackOf32, IntersectionFixture<pack32<float>>, SAMPLES, ITERATIONS) {
    for (auto r : rays_) {
        auto hit = intersection(r, aabb_, ray_aabb_intersection{});
        celero::DoNotOptimizeAway(hit);
    }
...
BENCHMARK_F(HitAABB, CudaArray, IntersectionFixture<enoki::CUDAArray<float>>, SAMPLES, ITERATIONS) {
    for (auto r : rays_) {
        auto hit = intersection(r, aabb_, ray_aabb_intersection{});
        celero::DoNotOptimizeAway(hit);
    }
